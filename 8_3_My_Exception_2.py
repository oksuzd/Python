...
Элементы запрашиваются бесконечно, пока пользователь сам не остановит работу скрипта, введя, команду “q”.
...
input_data = input("Введите число. Для выхода введите 'q'. ")
my_list = []
...
print(f"Введенные числа: {my_list}")
